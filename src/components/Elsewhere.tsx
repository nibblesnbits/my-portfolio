  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="story-text">
          Something about a ribbon. Or a chime. Or maybe a chime <em>with</em> a
        ...
        <p className="story-text">
          ...
          <br />
          He’d already veered left—off the path, around a hedge that looked like
          it had opinions about foot traffic, and into a field that was
        ...
        <p className="story-text">
          Not dramatically.
          <br />
          Just… a gentle crease. Like the Elsebeneath had gotten distracted and
          accidentally sat on this corner of itself.
        </p>
        <p className="story-text">
          The horizon tilted.
          <br />
        ...
        <p className="story-text">
          “It was humming.”
          <br />
          Fen held up the snack—something between a pastry and a musical regret.
          “I figured it was edible.”
        </p>
        <p className="story-text">
          Sam stared at him.
          <br />
        ...
        <p className="story-text">
          The wind nudged them forward with the soft confidence of a story that
          didn’t know how it ended—but
        ...
        <p className="story-text">
          The path narrowed, except it hadn’t had a width before, and now it was
          just <em>less than everything else</em> around it.
          <br />
        ...
        <p className="story-text">
          The hallway—if you could call it that—was doing its best impression of
          a Möbius strip that had read about hallways in a dream.
          <br />
        ...
        <p className="story-text">
          A small brass plaque shimmered into existence on a floating pedestal.
          It adjusted its height to match Sam’s eyeline, then winked out and
          reappeared at Fen’s shoulder instead.
        </p>
        ...
        <blockquote className="story-callout">
          <p className="story-text">
            ...
            <em>
              ...
              name incorrectly as a means of psychological advancement. However,
              if it helps you find the hallway, we won’t stop you. We
              <em>might</em> giggle.
            </em>
          </p>
        </blockquote>
        ...
        <p className="story-text">
          ...
          <strong>“DO NOT APOLOGIZE FOR THIS”</strong>, and another sat politely
          on the floor, humming to itself in C minor.
        </p>
        <p className="story-text">
        ...
        <p className="story-text">
          “I think it’s... the time I tried to be honest, but accidentally used
          sarcasm instead.”
          <br />
        ...
        <hr />
        <p className="story-text">
          A busboy passed by, entirely composed of index cards. One fell off and
          fluttered to Sam’s feet.
        </p>
        <p className="story-text">It read:</p>
        <blockquote className="story-callout">
          <p className="story-text">
            <em>
              “You said it didn’t matter, but you didn’t mean it. Would you like
              to try again?”
            </em>
          </p>
        </blockquote>
        ...
        <p className="story-text">“I didn’t mean to say anything last week.”</p>
        <blockquote className="story-callout">
          <p className="story-text">
        ...
        <blockquote className="story-callout">
          <p className="story-text">
            ...
            instability, emotional oversaturation, and a mild jellyfish-related
            incident.
          </p>
        </blockquote>
        <hr />
        ...
        <blockquote className="story-callout">
          <p className="story-text">
            ...
            emotional volatility, three misplaced metaphors, and one existential
            sandwich. Until the situation stabilizes, please proceed directly to
            Chapter 6: The Mirror of Correct Memory.]
          </p>
        </blockquote>
        <blockquote className="story-callout">
          <p className="story-text">
        ...
        <p className="story-text">Not like a dead end. More like a decision.</p>
        ...
        <p className="story-text">
          ...
          <br />
          It showed Sam at age five, in a superhero cape, crying because someone
          broke his action figure.
        </p>
        ...
        <p className="story-text">
          ...
          now somewhere between a hallway and a waiting room designed by someone
          who had only ever heard <em>of</em> furniture.
        </p>
        <p className="story-text">
        ...
        <p className="story-text">Fen flopped into his seat. Sam hesitated.</p>
        <blockquote className="story-callout">
          <p className="story-text">
        ...
        <blockquote className="story-callout">
          <p className="story-text">
            ...
            “So you almost left?”
            <br />
            <strong>Fen:</strong> “Don’t ruin it. That one’s still fermenting.”
          </p>
          <blockquote className="story-callout">
            <p className="story-text">
              <em>SOFT BUZZ.</em>
        ...
        <p className="story-text">
          Fen didn’t answer. But he smiled like someone who hadn’t said what he
          meant—on purpose.
        </p>
        ...
        <p className="story-text">
          He wore four scarves, no shoes, and the kind of layered clothing that
          said
          <strong>“I know what season it is, but I disagree.”</strong>
          <br />
          His face was lined but not tired.
          <br />
          His hands moved carefully—polishing a piece of old silver that didn’t
          reflect anything.
        </p>
        ...
        <p className="story-text">It smelled like static and old lullabies.</p>
        <p className="story-text">
        ...
        <p className="story-text">
          “It’s about <strong>what didn’t finish.</strong> What got paused. What
          got
          <em>refused.</em>”<br />
        ...
        <p className="story-text">
          Fen cleared his throat. “So what—somebody else’s echo hitchhiked into
          us?”
        </p>
        <p className="story-text">
        ...
        <p className="story-text">
          ...
          from the floorboards like the hallway had second thoughts about being
          whole.
        </p>
        <p className="story-text">
        ...
        <p className="story-text">
          Spools of ribbon hovered in the air—some stitched with phrases, others
          blank. A floating needle traced slow figure-eights in the center,
          pausing occasionally like it forgot what it was about to say.
        </p>
        <p className="story-text">
        ...
        <blockquote className="story-callout">
          <p className="story-text">
            ...
            <br />
            <em>Do not pull the thread unless you’re willing to follow it.</em>
          </p>
        </blockquote>
        ...
        <hr />
        <p className="story-text">The loom shivered as Fen stepped forward.</p>
        <p className="story-text">
        ...
        <p className="story-text">
          Sam tried to help—but the thread resisted. It snagged. Twisted. Formed
          shapes that looked like apologies but read like sarcasm.
        </p>
        ...
        <p className="story-text">
          “You tried to fix something that wasn’t broken,” it said gently. “You
          assumed mending is always welcome.”
        </p>
        <p className="story-text">
          Sam stammered. “We were just trying to help—”
        </p>
        <p className="story-text">The wall nodded. “Intent is not consent.”</p>
        <p className="story-text">
          The needle landed softly on the ground, curling into a question mark.
        </p>
        <p className="story-text">The room began to dissolve—softly. Kindly.</p>
        ...
        <hr />
        <p className="story-text">The corridor ended in a polite cul-de-sac.</p>
        <p className="story-text">
        ...
        <p className="story-text">
          Radiating the quiet authority of someone who’d seen too many metaphors
          misused and wasn’t afraid to file a complaint.
        </p>
        <hr />
        ...
        <p className="story-text">
          “You’ve interfered with four metaphor engines, disrespected one buffet
          of unresolved cognition,
          <br />
        ...
        <p className="story-text">Memories that wanted to finish themselves.</p>
        ...
        <p className="story-text">
          ...
          outgrown, or a tune that had changed key since the last time he hummed
          it.
        </p>
        ...
        <p className="story-text">
          ...
          <br />
          Fen tapped a rhythm on the table with one finger, like he was testing
          the emotional acoustics.
        </p>
